...
type Server struct {
	...
	Token *Server_TOKEN `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`
}
...
func (x *Server) GetToken() *Server_TOKEN {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *Server_TOKEN) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_TOKEN) ProtoMessage() {}

func (x *Server_TOKEN) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_TOKEN.ProtoReflect.Descriptor instead.
func (*Server_TOKEN) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_TOKEN) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x89, 0x03, 0x0a,
	...
	0x63, 0x12, 0x2e, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1f, 0x0a, 0x05, 0x54, 0x4f, 0x4b, 0x45, 0x4e,
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0xf9, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74,
	...
	0x63, 0x65, 0x1a, 0xcf, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18, 0x0a, 0x07,
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x22, 0x5a, 0x20, 0x73, 0x68, 0x6f, 0x70, 0x2f, 0x61, 0x70, 0x70,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_TOKEN)(nil),        // 5: kratos.api.Server.TOKEN
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.token:type_name -> kratos.api.Server.TOKEN
